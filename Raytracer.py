...
raytracer.scene.append(Sphere(position=(-0.5,0,-3),radius= 0.4 ,material=jupiter))
raytracer.scene.append(Triangle(verts=[(-1.5, 1, -5), (-2.5, -1, -4), (-0.5, -1, -5)], material=blueMirror))
raytracer.scene.append(Triangle(verts=[(-0.5,0,-2),(0.3,0.5,-2),(0.3,-0.3,-2)],material=pinkGlass))
raytracer.scene.append(Triangle(verts=[(0,-0.5,-4),(0.5,1,-4),(1.2,-0.5,-4)],material=dirt))
